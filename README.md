...
I worked on this project by following the Codebasics PowerBi Course, Link to the course is here [Course](https://codebasics.io/courses/power-bi-data-analysis-with-end-to-end-project)
